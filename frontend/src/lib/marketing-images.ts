...
export const marketingImages = {
  ...
  homeReviewExperience: '/home-review-experience-v2.jpg',
  homeReviewLevel: '/home-review-level-v2.jpg',
  homeReviewFun: '/home-review-fun-v4.jpg',
  homeReviewNofin: '/home-review-nofin-v2.jpg',
...
export const oceanImages = {
  hero: marketingImages.homeHeroBg,
...
export const imageAlt = {
  ...
  homeReviewExperience: '미미다이브 프리다이빙 체험다이빙 수강생',
  homeReviewLevel: '미미다이브 프리다이빙 레벨 교육 수강생 바다 훈련',
  homeReviewFun: '미미다이브 프리다이빙 트레이닝 코칭 수강생',
  homeReviewNofin: '미미다이브 노핀 프리다이빙 수강생 대회 출전',
