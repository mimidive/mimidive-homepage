...
export const programSections = [
  {
    ...
    title: '자격증 코스',
    subtitle: 'Level 1부터 강사과정까지, 단계별 국제 자격 과정',
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      '개인 수영복, 수모, 수건 준비. 기본 교육 장비는 과정에 따라 대여 가능.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '예약 규정에 따라 처리. 기상 악화 등 안전 사유 발생 시 일정 변경 우선 안내.',
  },
  {
    question: '장비가 없어도 참여할 수 있나요?',
    answer:
      '참여 가능합니다. 노핀 코스는 롱핀이 필요 없으며, 수영장·바다 환경에 따라 마스크, 스노클, 웻슈트 등 다른 장비가 필요할 수 있습니다. 장비 대여가 가능하니 상담을 통해 과정별 준비물을 확인해 주세요.',
  },
  {
    question: '혼자 신청해도 괜찮나요?',
    answer:
      '가능. 일정에 따라 단독 또는 그룹 수업 배정.',
  },
  {
    question: '교육 사진이나 영상도 받을 수 있나요?',
    answer:
      '피드백을 위한 수중 영상 촬영이 제공됩니다. 촬영본으로 자세, 호흡, 이퀄라이징 타이밍을 함께 확인합니다. 제공 범위와 분량은 과정과 학습 진도, 당일 컨디션에 따라 달라질 수 있습니다.',
  },
  {
    question: '노핀을 처음 해도 배울 수 있나요?',
    answer:
      '처음 하시는 분도 배울 수 있습니다. 노핀 기본 자세, 호흡, 수중 적응부터 차근차근 다룹니다. 개인별 수영 실력과 이퀄라이징 상태를 확인한 뒤, 맞는 단계와 속도로 수업이 진행됩니다.',
  },
] as const;
...
export const advancedCourseShared = {
  ...
  faqTitle: '자주 묻는 질문',
  faqs: [faqs[6], faqs[8], faqs[9]] as const,
};
...
export const experienceCourseShared = {
  ...
  faqTitle: '자주 묻는 질문',
  faqs: [faqs[0], faqs[1], faqs[7]] as const,
};
...
export const specialCourseShared = {
  ...
  faqTitle: '자주 묻는 질문',
  faqs: [faqs[5], faqs[6], faqs[7]] as const,
};
