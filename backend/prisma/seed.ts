...
async function main() {
  ...
  if (noticeCount === 0) {
    await prisma.notice.createMany({
      data: [
        {
          title: '2026년 여름 시즌 교육 일정 안내',
          content:
            '제주 바다와 함께하는 프리다이빙 시즌이 시작됩니다.\n\nAIDA 1~4 레벨 과정 및 체험다이빙 모집 중입니다. 교육일정 페이지에서 자세한 일정을 확인하시고, 신청해 주세요.',
        },
        {
          title: '신규 강사 과정 개설 안내',
          content:
            'AIDA 강사 과정이 7월에 개설됩니다. AIDA 4 자격 보유자 대상이며, 선착순 3명 모집입니다. 자세한 사항은 문의 바랍니다.',
        },
      ],
    });
  }
